...
public class ContractMemberAdapter extends RecyclerView.Adapter<ContractMemberAdapter.ContractViewHolder> {
    Context context;
    private List<Contract> contracts;
    private boolean isTerminated;

    public ContractMemberAdapter(Context context, List<Contract> contracts, boolean isTerminated) {
    ...
    public void onBindViewHolder(@NonNull ContractViewHolder holder, int position) {
        ...
        holder.rentAmount.setText(context.getString(R.string.rentAmount,String.valueOf(contract.getRentAmount())));
