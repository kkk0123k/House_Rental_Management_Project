...
public class LoginOwner extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_forgotPassword.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(LoginOwner.this, ResetPasswordOwner.class));
            }
        });
            ...
            mAuth.signInWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if (task.isSuccessful()) {
                        ...
                        progressDialog.dismiss();
                        Toast.makeText(LoginOwner.this, "Login Failed", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
    ...
    private void sendUserToMainActivity() {
        Intent intent = new Intent(LoginOwner.this, DashboardOwner.class);
