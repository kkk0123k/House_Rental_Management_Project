        ...
        if (user != null) {
            ...
            mDatabase.child("Users").child(userId).get().addOnCompleteListener(new OnCompleteListener<DataSnapshot>() {
                ...
                public void onComplete(@NonNull Task<DataSnapshot> task) {
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(com.example.houserentalmanagementproject.admin.UpdateProfile.this, "Error getting data", Toast.LENGTH_SHORT).show();
                    }
                }
            });
            ...
            copy_userID.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Toast.makeText(com.example.houserentalmanagementproject.admin.UpdateProfile.this, "User ID copied to clipboard", Toast.LENGTH_SHORT).show();
                }
            });
            btn_updateProfile.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (!newUsername.isEmpty() && !newEmail.isEmpty() && !newPhone.isEmpty()) {
                        ...
                        Toast.makeText(com.example.houserentalmanagementproject.admin.UpdateProfile.this, "Change user information successful", Toast.LENGTH_SHORT).show();
                        finish();
                    } else {
                        Toast.makeText(com.example.houserentalmanagementproject.admin.UpdateProfile.this, "Please fill out all fields", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
