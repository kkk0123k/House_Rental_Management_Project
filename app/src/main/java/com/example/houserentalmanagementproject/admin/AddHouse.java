...
public class AddHouse extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(com.example.houserentalmanagementproject.admin.AddHouse.this);
    ...
    private void createHouse(String houseLocation, String noOfRoom, String rentPerRoom, String houseDescription, String image, String search) {
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference().child(RegisterOwner.HOUSES).child(owner.getOwnerId());
        ...
        hashMap.put("userId", owner.getOwnerId());
        ...
        houseRef.setValue(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                if (task.isSuccessful()) {
                    Toast.makeText(com.example.houserentalmanagementproject.admin.AddHouse.this, "House have been added", Toast.LENGTH_SHORT).show();
                    imageString = "";
                    Intent intent = new Intent(com.example.houserentalmanagementproject.admin.AddHouse.this, DashboardOwner.class);
                    startActivity(intent);
                    finish();
                } else {
                    Toast.makeText(com.example.houserentalmanagementproject.admin.AddHouse.this, "Fail to add house", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private String getFileExtension(Uri uri) {
        ContentResolver contentResolver = com.example.houserentalmanagementproject.admin.AddHouse.this.getContentResolver();
        MimeTypeMap mimeTypeMap = MimeTypeMap.getSingleton();
        return mimeTypeMap.getExtensionFromMimeType(contentResolver.getType(uri));
    }

    private void uploadImage() {
        final ProgressDialog pd = new ProgressDialog(com.example.houserentalmanagementproject.admin.AddHouse.this);
        ...
        if (imageUri != null) {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    if (task.isSuccessful()) {
                        try {
                            ...
                            Glide.with(com.example.houserentalmanagementproject.admin.AddHouse.this).load(imageUri).into(iv_houseImage);
                        } catch (Exception e) {
                            Log.d("TAG1", "error Message: " + e.getMessage());
                            Toast.makeText(com.example.houserentalmanagementproject.admin.AddHouse.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                        pd.dismiss();
                    } else {
                        Toast.makeText(com.example.houserentalmanagementproject.admin.AddHouse.this, "Failed here", Toast.LENGTH_SHORT).show();
                        pd.dismiss();
                    }
                }
            ...
            Toast.makeText(com.example.houserentalmanagementproject.admin.AddHouse.this, "No image Selected", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == IMAGE_REQUEST && resultCode == RESULT_OK && data != null && data.getData() != null) {
            ...
            if (uploadTask != null && uploadTask.isInProgress()) {
                Toast.makeText(com.example.houserentalmanagementproject.admin.AddHouse.this, "Upload in progress", Toast.LENGTH_SHORT).show();
            } else {
                uploadImage();
            }
        }
    ...
    public void checkPermission(String permission, int requestCode) {
        ...
        if (ContextCompat.checkSelfPermission(com.example.houserentalmanagementproject.admin.AddHouse.this, permission) == PackageManager.PERMISSION_DENIED) {
            ActivityCompat.requestPermissions(com.example.houserentalmanagementproject.admin.AddHouse.this, new String[]{permission}, requestCode);
        } else {
            openImage();
            Toast.makeText(com.example.houserentalmanagementproject.admin.AddHouse.this, "Permission already granted", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void onRequestPermissionsResult(int requestCode,
        ...
        if (requestCode == STORAGE_PERMISSION_CODE) {
            if (grantResults.length > 0
                ...
                openImage();
                Toast.makeText(com.example.houserentalmanagementproject.admin.AddHouse.this, "Storage Permission Granted", Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(com.example.houserentalmanagementproject.admin.AddHouse.this, "Storage Permission Denied", Toast.LENGTH_SHORT).show();
            }
        }
    }
