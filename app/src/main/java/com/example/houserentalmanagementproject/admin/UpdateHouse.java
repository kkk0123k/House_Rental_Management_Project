...
public class UpdateHouse extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        house = (HouseModel) getIntent().getSerializableExtra("HOUSE_DATA");
    ...
    private void uploadImage() {
        final ProgressDialog pd = new ProgressDialog(com.example.houserentalmanagementproject.admin.UpdateHouse.this);
        ...
        uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
            ...
            public void onComplete(@NonNull Task<Uri> task) {
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(com.example.houserentalmanagementproject.admin.UpdateHouse.this, "Failed!", Toast.LENGTH_SHORT).show();
                    pd.dismiss();
                }
            }
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(com.example.houserentalmanagementproject.admin.UpdateHouse.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                pd.dismiss();
            }
        });
    }
    ...
    private String getFileExtension(Uri uri) {
        ContentResolver contentResolver = com.example.houserentalmanagementproject.admin.UpdateHouse.this.getContentResolver();
    ...
    private void updateHouseDetails() {
        ...
        ref.setValue(house).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    Toast.makeText(com.example.houserentalmanagementproject.admin.UpdateHouse.this, "House updated", Toast.LENGTH_SHORT).show();
                    // Navigate back to the HouseDetails activity
                    finish();
                } else {
                    Toast.makeText(com.example.houserentalmanagementproject.admin.UpdateHouse.this, "Failed to update house", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
